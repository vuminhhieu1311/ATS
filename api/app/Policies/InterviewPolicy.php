...
class InterviewPolicy
{
    ...
    {
        return $user->hasAnyPermission([Permission::MANAGE_INTERVIEW_SCHEDULE, Permission::VIEW_INTERVIEW_SCHEDULE]);
    }
    ...
    {
        return $user->can(Permission::MANAGE_INTERVIEW_SCHEDULE);
    }
